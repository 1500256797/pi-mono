...
Reusable web UI components for building AI chat interfaces powered by [@ouhuang/pi-ai](../ai) and [@ouhuang/pi-agent-core](../agent).
...
```bash
npm install @ouhuang/pi-web-ui @ouhuang/pi-agent-core @ouhuang/pi-ai
```
...
```typescript
import { Agent } from '@ouhuang/pi-agent-core';
...
import {
  ...
  defaultConvertToLlm,
  ApiKeyPromptDialog,
} from '@ouhuang/pi-web-ui';
import '@ouhuang/pi-web-ui/app.css';
...
```typescript
import { defaultConvertToLlm, convertAttachments } from '@ouhuang/pi-web-ui';
...
```typescript
import { createJavaScriptReplTool } from '@ouhuang/pi-web-ui';
...
```typescript
import { createExtractDocumentTool } from '@ouhuang/pi-web-ui';
...
```typescript
import { registerToolRenderer, type ToolRenderer } from '@ouhuang/pi-web-ui';
...
```typescript
import { loadAttachment, type Attachment } from '@ouhuang/pi-web-ui';
...
```typescript
import { createStreamFn, shouldUseProxyForProvider, isCorsError } from '@ouhuang/pi-web-ui';
...
```typescript
import { SettingsDialog, ProvidersModelsTab, ProxyTab, ApiKeysTab } from '@ouhuang/pi-web-ui';
...
```typescript
import { SessionListDialog } from '@ouhuang/pi-web-ui';
...
```typescript
import { ApiKeyPromptDialog } from '@ouhuang/pi-web-ui';
...
```typescript
import { ModelSelector } from '@ouhuang/pi-web-ui';
...
```typescript
import { i18n, setLanguage, translations } from '@ouhuang/pi-web-ui';
