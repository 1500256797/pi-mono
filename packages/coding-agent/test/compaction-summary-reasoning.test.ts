...
import type { AssistantMessage, Model } from "@ouhuang/pi-ai";
...
vi.mock("@ouhuang/pi-ai", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@ouhuang/pi-ai")>();
	return {
		...actual,
