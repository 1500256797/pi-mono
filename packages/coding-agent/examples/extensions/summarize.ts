import { complete, getModel } from "@ouhuang/pi-ai";
import type { ExtensionAPI, ExtensionCommandContext } from "@ouhuang/pi-coding-agent";
import { DynamicBorder, getMarkdownTheme } from "@ouhuang/pi-coding-agent";
import { Container, Markdown, matchesKey, Text } from "@ouhuang/pi-tui";
