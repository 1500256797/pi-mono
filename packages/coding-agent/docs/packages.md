...
Pi bundles core packages for extensions and skills. If you import any of these, list them in `peerDependencies` with a `"*"` range and do not bundle them: `@ouhuang/pi-ai`, `@ouhuang/pi-agent-core`, `@ouhuang/pi-coding-agent`, `@ouhuang/pi-tui`, `@sinclair/typebox`.
