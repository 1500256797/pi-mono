...
For TypeScript definitions in your project, inspect `node_modules/@ouhuang/pi-coding-agent/dist/`.
...
```typescript
import { convertToLlm, serializeConversation } from "@ouhuang/pi-coding-agent";
