...
import type { EditorTheme, MarkdownTheme, SelectListTheme } from "@ouhuang/pi-tui";
...
const THEME_KEY = Symbol.for("@ouhuang/pi-coding-agent:theme");
...
export function getSettingsListTheme(): import("@ouhuang/pi-tui").SettingsListTheme {
	return {
