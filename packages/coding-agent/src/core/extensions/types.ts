...
import type { AgentMessage, AgentToolResult, AgentToolUpdateCallback, ThinkingLevel } from "@ouhuang/pi-agent-core";
import type {
	Api,
...
export interface ExtensionUIContext {
	 ...
	 * extend `CustomEditor` from `@ouhuang/pi-coding-agent` and call
	 * `super.handleInput(data)` for keys you don't handle.
	 *
	 * @example
	 * ```ts
	 * import { CustomEditor } from "@ouhuang/pi-coding-agent";
	 *
