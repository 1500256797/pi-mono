...
<p align="center">
  ...
  <a href="https://www.npmjs.com/package/@ouhuang/pi-coding-agent"><img alt="npm" src="https://img.shields.io/npm/v/@ouhuang/pi-coding-agent?style=flat-square" /></a>
...
```bash
npm install -g @ouhuang/pi-coding-agent
```
...
- [@ouhuang/pi-ai](https://www.npmjs.com/package/@ouhuang/pi-ai): Core LLM toolkit
- [@ouhuang/pi-agent](https://www.npmjs.com/package/@ouhuang/pi-agent): Agent framework
- [@ouhuang/pi-tui](https://www.npmjs.com/package/@ouhuang/pi-tui): Terminal UI components
