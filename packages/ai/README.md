...
```bash
npm install @ouhuang/pi-ai
```

TypeBox exports are re-exported from `@ouhuang/pi-ai`: `Type`, `Static`, and `TSchema`.

## Quick Start

```typescript
import { Type, getModel, stream, complete, Context, Tool, StringEnum } from '@ouhuang/pi-ai';
...
```typescript
import { Type, Tool, StringEnum } from '@ouhuang/pi-ai';
...
```typescript
import { stream, validateToolCall, Tool } from '@ouhuang/pi-ai';
...
```typescript
import { readFileSync } from 'fs';
import { getModel, complete } from '@ouhuang/pi-ai';
...
```typescript
import { getModel, streamSimple, completeSimple } from '@ouhuang/pi-ai';
...
```typescript
import { getModel, stream } from '@ouhuang/pi-ai';
...
```typescript
import { getProviders, getModels, getModel } from '@ouhuang/pi-ai';
...
```typescript
import { Model, stream } from '@ouhuang/pi-ai';
...
```typescript
import { streamAnthropic, type AnthropicOptions } from '@ouhuang/pi-ai';
...
```typescript
import { getModel, complete, Context } from '@ouhuang/pi-ai';
...
```typescript
import { Context, getModel, complete } from '@ouhuang/pi-ai';
...
- OAuth login flows are not supported in browser environments. Use the `@ouhuang/pi-ai/oauth` entry point in Node.js.
...
```typescript
import { getEnvApiKey } from '@ouhuang/pi-ai';
...
```bash
npx @ouhuang/pi-ai login              # interactive provider selection
npx @ouhuang/pi-ai login anthropic    # login to specific provider
npx @ouhuang/pi-ai list               # list available providers
```
...
The library provides login and token refresh functions via the `@ouhuang/pi-ai/oauth` entry point. Credential storage is the caller's responsibility.
...
} from '@ouhuang/pi-ai/oauth';
```

### Login Flow Example

```typescript
import { loginGitHubCopilot } from '@ouhuang/pi-ai/oauth';
...
```typescript
import { getModel, complete } from '@ouhuang/pi-ai';
import { getOAuthApiKey } from '@ouhuang/pi-ai/oauth';
...
- Add any root-level `export type` re-exports in `src/index.ts` that should remain available from `@ouhuang/pi-ai`
